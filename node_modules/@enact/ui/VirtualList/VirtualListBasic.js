...
var VirtualListBasic = exports.VirtualListBasic = /*#__PURE__*/function (_Component) {
  ...
  _createClass(VirtualListBasic, [{
    ...
    value: function componentDidUpdate(prevProps, prevState) {
      var _prevProps$itemSizes, _this$props$itemSizes;
      ...
      if (prevProps.direction !== this.props.direction || prevProps.overhang !== this.props.overhang || prevProps.spacing !== this.props.spacing || !(0, _equals["default"])(prevProps.itemSize, this.props.itemSize) || ((_prevProps$itemSizes = prevProps.itemSizes) === null || _prevProps$itemSizes === void 0 ? void 0 : _prevProps$itemSizes.reduce(function (acc, cur) {
        return acc + cur;
      }, 0)) !== ((_this$props$itemSizes = this.props.itemSizes) === null || _this$props$itemSizes === void 0 ? void 0 : _this$props$itemSizes.reduce(function (acc, cur) {
        return acc + cur;
      }, 0))) {
