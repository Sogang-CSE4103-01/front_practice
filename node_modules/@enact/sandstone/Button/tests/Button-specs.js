...
describe('Button', function () {
  ...
  describe('with shadowed', function () {
    test('should have shadowed class when the background is transparent', function () {
      (0, _react.render)( /*#__PURE__*/(0, _jsxRuntime.jsx)(_Button["default"], {
        shadowed: true,
        backgroundOpacity: "transparent"
      }));
      var button = _react.screen.getByRole('button');
      var expected = 'shadowed';
      expect(button).toHaveClass(expected);
    });
    test('should have shadowed class when the background is undefined and has icon only', function () {
      (0, _react.render)( /*#__PURE__*/(0, _jsxRuntime.jsx)(_Button["default"], {
        shadowed: true,
        icon: "check"
      }));
    ...
    test('should not have shadowed class when the background is not transparent', function () {
      (0, _react.render)( /*#__PURE__*/(0, _jsxRuntime.jsx)(_Button["default"], {
        shadowed: true,
  ...
  describe('events', function () {
    test('should call onClick when not disabled', /*#__PURE__*/_asyncToGenerator(function* () {
    ...
    test('should not call onClick when disabled', /*#__PURE__*/_asyncToGenerator(function* () {
      var handleClick = jest.fn();
      var user = _userEvent["default"].setup();
      (0, _react.render)( /*#__PURE__*/(0, _jsxRuntime.jsx)(_Button["default"], {
        disabled: true,
