...
describe('PageViews Specs', function () {
  test('should show next button and hide previous button on the first page', function () {
    ...
    var prevButton = _react.screen.queryByLabelText('Previous');
    expect(nextButton).toBeInTheDocument();
    expect(prevButton).toBeNull();
  });
  test('should show next button and hide previous button on the first page when pageIndicatorType is `number`', function () {
    (0, _react.render)( /*#__PURE__*/(0, _jsxRuntime.jsxs)(_.PageViews, {
  ...
  test('should show previous button and hide next button on the last page', function () {
    (0, _react.render)( /*#__PURE__*/(0, _jsxRuntime.jsxs)(_.PageViews, {
      index: 1,
      children: [/*#__PURE__*/(0, _jsxRuntime.jsx)(_.Page, {
        children: "I gots contents"
    ...
    var nextButton = _react.screen.queryByLabelText('Next');
    expect(prevButton).toBeInTheDocument();
    expect(nextButton).toBeNull();
  });
  test('should show previous button and hide next button on the last page when pageIndicatorType is `number`', function () {
    (0, _react.render)( /*#__PURE__*/(0, _jsxRuntime.jsxs)(_.PageViews, {
      pageIndicatorType: "number",
      index: 1,
      children: [/*#__PURE__*/(0, _jsxRuntime.jsx)(_.Page, {
  ...
  test('should fire onTransition with target index and type', /*#__PURE__*/_asyncToGenerator(function* () {
    var spy = jest.fn();
    var index = 0;
    var _render = (0, _react.render)( /*#__PURE__*/(0, _jsxRuntime.jsxs)(_.PageViews, {
        index: index,
        onTransition: spy,
        noAnimation: true,
        children: [/*#__PURE__*/(0, _jsxRuntime.jsx)(_.Page, {
  ...
  test('should fire onWillTransition with target index and type', /*#__PURE__*/_asyncToGenerator(function* () {
    var spy = jest.fn();
    var index = 0;
    var _render2 = (0, _react.render)( /*#__PURE__*/(0, _jsxRuntime.jsxs)(_.PageViews, {
        index: index,
  ...
  test('should fire `onNextClick` and `onChange` with type when go to the next page', /*#__PURE__*/_asyncToGenerator(function* () {
  ...
  test('should fire `onPrevClick` and `onChange` with type when go to the previous page', /*#__PURE__*/_asyncToGenerator(function* () {
    var handleChange = jest.fn();
